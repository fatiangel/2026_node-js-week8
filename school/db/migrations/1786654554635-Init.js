 ...
 */
module.exports = class Init1786654554635 {
    name = 'Init1786654554635'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "GRADE" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "student_id" uuid NOT NULL, "subject_id" uuid NOT NULL, CONSTRAINT "PK_bd0bb90149430debd6371dd718a" PRIMARY KEY ("id"))`);
